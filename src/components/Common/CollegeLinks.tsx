...
const Collegelinks = () => {
    ...
    return (
        <div className="hidden lg:flex sticky top-16 z-20 w-full bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm border-b border-gray-200 dark:border-gray-800 shadow-sm">
