                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                        ...
                        >
                             <div className="relative">
                                ...
                                <PersonStanding className={`w-10 h-10 text-sky-600 dark:text-sky-400 ${timeLeft > 0 ? 'animate-bounce' : ''}`} />
                                {timeLeft > 0 && (
                    ...
                    <div className="flex gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-amber-700 dark:text-amber-400">
                                Please share the link with friends instead of the file to support us.
                            </p>
                        </div>
                    </div>
                </div>
