        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              No resources available at the moment. Be the first to share!
            </p>
          </div>
        </div>
      </section>
    ...
    <section className="py-16">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-fugaz sm:text-5xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-sky-600 to-cyan-600 dark:from-sky-400 dark:to-cyan-400">
            Featured Resources
          </h2>
          <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto text-lg">
            Access study materials, books, and academic resources from your
            seniors
          </p>
        </div>
                  ...
                  <div className="flex items-center justify-between text-sm text-gray-500 dark:text-gray-400 mb-4">
                    <div className="flex items-center space-x-2">
                      <div className="w-8 h-8 rounded-full bg-gradient-to-br from-sky-500 to-cyan-500 flex items-center justify-center text-white text-xs font-semibold">
                        {(product.owner?.username || "A")[0].toUpperCase()}
                      </div>
                      <span className="text-xs text-gray-500 dark:text-gray-400">
                        By {product.owner?.username || "Anonymous"}
                      </span>
                    </div>
