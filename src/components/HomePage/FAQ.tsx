    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 transition-colors duration-300">
        ...
        <section className="pt-10 px-4">
          <div className="max-w-4xl mx-auto text-center">
            <div className="mb-8">
              ...
              <h1 className="text-4xl font-fugaz md:text-6xl font-bold text-gray-900 dark:text-white mb-4">
                Frequently Asked{" "}
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto leading-relaxed">
                Find quick answers to common questions about Student Senior...
              </p>
            </div>
              ...
              >
                ...
                >
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <h3 className="text-lg font-fugaz md:text-xl font-semibold text-gray-900 dark:text-white">
                        {faq.question}
                      </h3>
                      {faq.category && (
        ...
        <section className="py-16 px-4 bg-white dark:bg-gray-800">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-fugaz md:text-4xl font-bold text-gray-900 dark:text-white mb-6">
