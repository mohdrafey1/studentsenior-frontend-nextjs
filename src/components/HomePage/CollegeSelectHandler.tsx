  ...
  return (
    <div className="w-full max-w-md mx-auto">
      <div className="relative">
        {/* <div className="flex items-center space-x-4">
          <div className="flex-1">
            <select
              id="college-select"
              className=" p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all duration-200 text-gray-900 bg-white"
      ...
      {/* <p className="text-sm text-gray-500 mt-3 text-center">
        ...
        <Link href="/add-college" className="text-blue-600 hover:underline">
          Click here
        </Link>{" "}
        to add it.
      </p> */}
