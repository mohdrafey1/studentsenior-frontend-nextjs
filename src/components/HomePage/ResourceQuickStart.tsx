...
export default function ResourceQuickStart({ colleges }: Props) {
  ...
  useEffect(() => {
    ...
    try {
      ...
      setIsEditing(!(pref.collegeSlug && pref.courseCode && pref.branchCode));
    } catch {
      setIsEditing(true);
    }
  }, []);
      ...
      <div className="relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-3xl border border-gray-200/50 dark:border-gray-700/50 shadow-xl shadow-sky-100/50 dark:shadow-gray-900/30 p-6 sm:p-8 transition-all duration-300 hover:shadow-2xl hover:shadow-sky-200/60 dark:hover:shadow-gray-900/40">
        ...
        <div className="relative z-10 mb-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="text-xl font-fugaz font-bold bg-gradient-to-r from-gray-900 to-gray-700 dark:from-white dark:to-gray-300 bg-clip-text text-transparent">
        ...
        {!isEditing ? (
          ...
          <div className="relative z-10 space-y-6">
            ...
            <div className="bg-gradient-to-r from-sky-50 to-cyan-50 dark:from-sky-900/20 dark:to-cyan-900/20 rounded-2xl p-5 border border-sky-200/50 dark:border-sky-700/50">
              <h4 className="text-sm font-fugaz font-semibold text-sky-800 dark:text-sky-300 mb-4 flex items-center gap-2">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium text-gray-900 dark:text-gray-100">
                      {colleges.find((c) => c.slug === collegeSlug)?.name ||
                        collegeSlug}
                    </p>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <select
                    ...
                    disabled={!courseCode || loadingBranches}
                  >
                    <option value="">
                      {loadingBranches
                        ? "Loading branches..."
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  >
                    <option value="">
                      {!branchCode ? "Select branch first" : "All semesters"}
                    </option>
                    {semesters.map((s) => (
