        ...
        >
            ...
            <div className="relative h-52 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-700 overflow-hidden">
                ...
                {ownerId === item.owner._id && (
                    <div
                        className="absolute top-3 right-3 flex gap-1.5 opacity-60 group-hover:opacity-100 transition-opacity duration-300"
                        style={{ marginTop: item.available ? "40px" : "0" }}
                    >
                        <button
                            onClick={() => onEdit(item)}
                ...
                <div className="space-y-3 mb-4">
                    {item.whatsapp && (
                        <a
                            ...
                            className="flex items-center group/contact p-3 rounded-xl bg-gray-50/50 hover:bg-emerald-50 dark:bg-gray-800/50 dark:hover:bg-emerald-900/20 transition-all duration-300 hover:scale-[1.02] hover:shadow-md"
                        >
                            <div className="p-2 rounded-lg bg-emerald-100 dark:bg-emerald-900/40 group-hover/contact:bg-emerald-200 dark:group-hover/contact:bg-emerald-800/60 transition-colors duration-200">
                                <Phone className="w-4 h-4 text-emerald-600 dark:text-emerald-400" />
                            </div>
                            <span className="ml-3 text-gray-700 dark:text-gray-300 group-hover/contact:text-emerald-700 dark:group-hover/contact:text-emerald-300 transition-colors duration-200 font-medium">
                                WhatsApp
                            </span>
                        </a>
                    )}
                    {/* {item.telegram && (
                        ...
                        >
                            ...
                            <span className="ml-3 text-gray-700 dark:text-gray-300 group-hover/contact:text-sky-700 dark:group-hover/contact:text-sky-300 transition-colors duration-200 font-medium">
                                Telegram
                            </span>
                        </a>
                    )} */}
