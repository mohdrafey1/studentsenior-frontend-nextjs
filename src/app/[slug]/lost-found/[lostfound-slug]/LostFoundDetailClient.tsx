    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-purple-50/30 dark:from-gray-900 dark:via-blue-950/20 dark:to-purple-950/20 relative overflow-hidden">
            ...
            <div className="relative max-w-5xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
                ...
                <button
                    onClick={() => router.back()}
                    className="group mb-8 inline-flex items-center px-4 py-2 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-all duration-300 rounded-full shadow-sm hover:shadow-md hover:scale-105 border border-gray-200/50 dark:border-gray-700/50"
                >
