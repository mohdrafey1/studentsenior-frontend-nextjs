...
export default function SubjectVideosPage({ params }: any) {
...
const handleAddVideo = (value: boolean) => setOpenAddVideo(value);
    ...
    const handleVideoSubmit = async (formData: VideoFormData) => {
        const { subject,thumbnailUrl, ...rest } = formData;
    const bodyData = {
        ...rest,
        college: slug,
    };
    ...
    return (
        ...
        <meta name="description" content="Educational videos and lectures for the subject" />
      </Head>
            <DetailPageNavbar
                path="subjects"
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                            <div>
                                ...
                                <p className="text-gray-600 dark:text-gray-400 mt-1">
                                    Educational videos and lectures to help you learn
                                </p>
                            </div>
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-12">
                            <div className="text-center">
                                ...
                                <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-md mx-auto">
                                    Be the first to contribute educational videos for this subject.
                                </p>
                                <button
                                    onClick={()=> handleAddVideo(true)}
                                    ...
                                    <div className="p-4">
                                        ...
                                        {video?.clickCounts !== undefined && (
                                            <div className="flex mt-2 items-center gap-1 text-xs text-gray-500 dark:text-gray-400 mb-4">
                                                ...
                                                <span>{video?.clickCounts} views</span>
                                            </div>
                                        )}
                                    </div>
