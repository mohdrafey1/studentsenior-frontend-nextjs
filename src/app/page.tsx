...
export const metadata: Metadata = {
  title:
    "Student Senior - Academic Mentorship, PYQs & Student Resources Platform",
  description:
          ...
          <div className="relativ z-10 flex flex-col items-center justify-center px-4 py-16">
            ...
            <div className="text-center max-w-4xl mx-auto ">
              ...
              <p className="text-xl sm:text-2xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto animate-fade-in-delay">
                Connect with seniors, access resources, and grow your academic
                journey
              </p>
              <a href="#QuickStart">
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                Your one-stop platform for academic success and peer connection
              </p>
            </div>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center p-6 bg-white dark:bg-gray-700 rounded-xl shadow-sm dark:shadow-gray-900/20">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Connect with experienced seniors and get personalized academic
                  guidance
                </p>
              </div>
              <div className="text-center p-6 bg-white dark:bg-gray-700 rounded-xl shadow-sm dark:shadow-gray-900/20">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Access past year questions, study notes, and curated academic
                  materials
                </p>
              </div>
              <div className="text-center p-6 bg-white dark:bg-gray-700 rounded-xl shadow-sm dark:shadow-gray-900/20">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Join thousands of students sharing knowledge and supporting
                  each other
                </p>
              </div>
            </div>
