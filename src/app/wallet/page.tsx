    ...
    return (
        <div className='min-h-screen bg-gradient-to-br from-gray-50 to-gray-100'>
            <div className='max-w-7xl mx-auto p-4 sm:p-6 lg:p-8'>
                ...
                {/* Alerts */}
                {error && (
                    <div className='mb-6 p-4 rounded-lg border border-red-200 bg-red-50 text-red-700 shadow-sm'>
                ...
                {message && (
                    <div className='mb-6 p-4 rounded-lg border border-green-200 bg-green-50 text-green-700 shadow-sm'>
                        <div className='flex items-start gap-3'>
                        ...
                        <div className='flex'>
                            ...
                            >
                                <span className='flex items-center justify-center gap-2'>
                                    ...
                                    <span className='ml-2 px-2 py-0.5 rounded-full bg-gray-200 text-xs font-medium'>
                                        {filtered.length}
                                    </span>
                                </span>
                            </button>
                        ...
                        <>
                                        ...
                                        {loading ? (
                                            ...
                                            current.map((t) => (
                                                ...
                                                >
                                                    ...
                                                    ${t.type === 'add' || t.type === 'earn' || t.type === 'sale' || t.type === 'bonus' || t.type === 'refund' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}
                                                        >
                                                            {t.type}
                                                        </span>
                                                    </td>
                                                    <td
                                                        className={`px-6 py-4 whitespace-nowrap text-sm font-semibold ${t.points >= 0 ? 'text-green-600' : 'text-red-600'}`}
                                                    >
                                                        {t.points >= 0
                                                            ? '+'
                                                            : ''}
                            ...
                            <div className='px-6 py-4 bg-gray-50 border-t border-gray-200 flex items-center justify-between'>
                                ...
                                <div className='flex items-center gap-2'>
                                    ...
                                    <button
                                        className='px-4 py-2 border border-gray-300 rounded-lg text-sm font-medium hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed transition-colors'
                                        disabled={page === 1}
                                        onClick={() =>
                                        ...
                                        {loading ? (
                                            ...
                                            currentRedemptions.map((r) => (
                                                ...
                                                >
                                                    ...
                                                    <td className='px-6 py-4 whitespace-nowrap'>
                                                        <span
                                                            className={`inline-flex px-2.5 py-1 rounded-full text-xs font-medium border ${getStatusBadgeColor(r.status)}`}
                                                        >
                                                            {r.status}
                                                        </span>
                                                    </td>
                ...
                {showAddModal && (
                    <div className='fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4'>
                        <div className='w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl transform transition-all'>
                            ...
                            >
                                <div>
                                    ...
                                    <input
                                        ...
                                        className='w-full border-2 border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all text-lg'
                                ...
                                <div className='bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-4 border border-blue-200'>
                                    ...
                                    <div className='text-xs text-gray-600 mt-1 flex items-center gap-2'>
                                        <span className='inline-flex items-center px-2 py-0.5 rounded bg-white text-gray-700 font-medium'>
                                            5 pts = ₹1
                                        </span>
                                        <span>•</span>
                                        <span>
                                ...
                                <div className='flex gap-3 pt-2'>
                                    <button
                                        type='button'
                                        onClick={() => setShowAddModal(false)}
                                        className='flex-1 px-4 py-3 rounded-lg border-2 border-gray-300 hover:bg-gray-50 font-medium transition-colors'
                                    >
                                        Cancel
                                    </button>
                                    <button
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className='w-full border-2 border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:border-green-500 focus:ring-2 focus:ring-green-200 transition-all text-lg'
                                        placeholder='Enter points'
                                        required
                                    />
                                    <p className='text-xs text-gray-500 mt-1'>
