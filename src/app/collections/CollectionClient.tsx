...
const CollectionClient = () => {
  ...
  const { savedPYQs, savedNotes, purchasedPYQs, purchasedNotes } = useSelector(
          ...
          <div className="flex flex-col sm:flex-row justify-between sm:items-start gap-2">
            ...
            <div className="text-right">
              <span className="text-sm text-gray-500 dark:text-gray-400">
                ...
                {formatDate(
                  (!isPurchased && (item as { savedAt?: string }).savedAt) ||
                    pyq.createdAt
                )}
              </span>
              {pyq.isPaid && (
  ...
  const renderNoteCard = (
    item: { _id?: string; noteId?: INote | string; savedAt?: string } | INote,
    isPurchased = false
  ) => {
    // Handle both structures from the data
    const note = (
        ...
        <div className="bg-gray-50 dark:bg-gray-900/40 border-t border-gray-100 dark:border-gray-700/60 px-4 py-3 flex justify-between items-center">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="flex items-center text-sm text-gray-600 dark:text-gray-300">
              ...
              {Array.isArray((note as unknown as { likes?: unknown[] }).likes)
                ? (
    ...
    <div className="max-w-7xl min-h-screen mx-auto px-4 py-6 bg-white dark:bg-gray-900">
      ...
      <div className="mb-6 overflow-x-auto">
        <div className="border-b border-gray-200 dark:border-gray-700 min-w-max">
          <nav className="flex space-x-0 sm:space-x-8" aria-label="Tabs">
            {tabs.map((tab) => (
              <button
                key={tab.id}
